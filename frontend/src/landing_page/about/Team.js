     ...
     return ( 
      ...
      <div className="row p-3  text-muted" style={{lineHeight:"1.8",fontSize:"1.2em"}}>
        ...
        <div className="col-6 p-3 fs-5">
          ...
          <p>Connect on <a href="www" style={{textDecoration:"none"}}>Homepage </a> / <a href="www" style={{textDecoration:"none"}}>TradingQnA</a>/<a href="www" style={{textDecoration:"none"}}>Twitter</a></p>
        </div>
      </div>
    </div>
      );
