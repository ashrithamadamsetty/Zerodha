...
function Navbar() {
  ...
  <div class="container p-2">
    <Link class="navbar-brand" to="/"><img src="media/images/logo.svg" alt="" style={{width:"25%"}}/>
</Link>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <form class="d-flex" role="search">
       <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <Link class="nav-link active" href="https://example.com"><i class="fa fa-list"></i></Link>
        </li>
      </ul>
      </form>
    </div>
